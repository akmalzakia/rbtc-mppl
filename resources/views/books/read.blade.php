<x-main-layout>
    <div class="flex flex-col items-center">
        <div class="flex space-x-3 px-1 py-2 w-3/4 justify-between items-center">
            <button class="inline-flex p-2 bg-blue-800 text-white rounded-md gap-2 hover:bg-blue-900" id="prev-page"><i
            ...
            <div class="flex flex-col space-y-1">
                <form action="/bookmark" method="POST" id="bookmark-form">
                    ...
                    <button type="submit" class="bg-blue-800 text-white text-sm rounded-md p-2 inline-flex items-center space-x-1 hover:bg-blue-900"><i height="16" width="16" data-feather="bookmark"></i> Bookmark</button>
                </form>
                <span class="self-center" id="page-info">
                    Page <span id="page-num" onchange=""></span> of <span id="page-count"></span>
                </span>
            </div>
            <button class="inline-flex p-2 bg-blue-800 text-white rounded-md gap-2 hover:bg-blue-900" id="next-page">Next Page <i
